...
Handles PDF, DOCX, TXT, CSV, and URL loading using LangChain v0.3.x"""
...
class DocumentProcessor:
    ...
    def load_csv(self, file_path: str) -> List[Document]:
        """
        Load CSV by flattening rows into text.
        
        Args:
            file_path: Path to CSV file
            
        Returns:
            List containing a single Document with CSV contents
        """
        rows = []
